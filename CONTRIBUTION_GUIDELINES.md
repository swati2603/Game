# Contribution Guidelines [![contributions welcome](https://img.shields.io/badge/contributions-welcome-brightgreen.svg?style=flat)](https://github.com/swati2603/Game/issues) 🤝🏽🍀:
...
*1.*  Fork [this](https://github.com/swati2603/Game.git) repository.
...
git clone --depth 1 https://github.com/<your_user_name>/Game.git
...
git remote add upstream https://github.com/swati2603/Game.git 
...
- Comment on any existing [issue(s)](https://github.com/swati2603/Game/issues) raised by *project maintainers*. Otherwise raise a [new issue](https://github.com/swati2603/Game/issues/new).
...
*9.* Voila :exclamation: You have made a PR to the Game : boom . Sit back patiently and relax while the project maintainers review your PR. Please understand at times the time can vary from a few hours to a few days.
